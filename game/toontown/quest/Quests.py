...
QuestDict = {
    #Test Sellbot Access
    170: ([], Start, (VisitQuest,), 2001, 2001, NA, 171, DefaultDialog),
    171: ([], Cont, (CogQuest, Anywhere, 1, 'nd'), 2001, 2001, 100, 172, DefaultDialog),
    172: ([], Cont, (CogQuest, Anywhere, 1, 'cc'), 2001, 2001, 100, 173, DefaultDialog),
    173: ([], Cont, (CogQuest, Anywhere, 1, Any), 2001, 2001, 101, NA, DefaultDialog),

    #Test Tasks
    164: ([], Start, (VisitQuest,), 2001, 2003, NA, 165, DefaultDialog),
    165: ([], Cont, (CogQuest, Anywhere, 1, Any), 2003, 2003, 100, 166, DefaultDialog),
    166: ([], Cont, (CogQuest, Anywhere, 1, 'f'), 2003, 2003, 102, 167, DefaultDialog),
    167: ([], Cont, (CogQuest, Anywhere, 1, Any), 2003, 2003, 300, NA, DefaultDialog)}
